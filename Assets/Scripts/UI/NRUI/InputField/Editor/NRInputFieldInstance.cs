...
{
    public class NRInputFieldInstace : Editor
    {
        private static GameObject clickedObject;
        [MenuItem("GameObject/NotReaper UI/NRInputField", priority = 0)]
        ...
        {
            var instance = Instantiate(Resources.Load<NRInputField>(objectName));
